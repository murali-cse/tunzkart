                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            ...
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-wishlist btn-expandable"
                                                    style="background-color: white"><span>add to
                                                        wishlist</span></a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Brown
                                                    paperbag waist pencil
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Dark
                                                    yellow lace cut out
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Khaki
                                                    utility boiler
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Blue
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Beige
                                                    knitted elastic
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Orange
                                                    saddle lock front
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Light
                                                    brown studded Wide
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Yellow
                                                    button front tea
                                ...
                                <div class="col-6 col-md-4 col-lg-4">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="<?php echo base_url('product') ?>">Black
                                                    soft RI weekend
    ...
    <div class="mobile-menu-wrapper">
        ...
        <nav class="mobile-nav">
            <ul class="mobile-menu">
                ...
                <li>
                    <a href="<?php echo base_url('product') ?>" class="sf-with-ul">Product</a>
                    <ul>
                        <li><a href="<?php echo base_url('product') ?>">Default</a></li>
